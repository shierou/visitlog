...
const REGION_RULES: readonly Rule[] = [
  ...
  { value: '성남·판교', keywords: ['판교', '분당', '성남', '서현', '정자'] },
  { value: '수원·용인', keywords: ['수원', '용인', '광교', '동탄'] },
  { value: '고양·일산', keywords: ['일산', '고양', '킨텍스'] },
  { value: '부천·광명', keywords: ['부천', '광명', '시흥'] },
  { value: '안양·과천', keywords: ['안양', '평촌', '과천', '의왕'] },
  { value: '남양주·구리', keywords: ['남양주', '구리', '하남', '미사'] },
  { value: '파주', keywords: ['파주', '헤이리', '운정'] },
  { value: '가평·양평', keywords: ['가평', '양평', '청평'] },
  { value: '경기', keywords: ['경기', '포천'] },
  ...
  // 권역이 먼저고 '서울' 은 그 뒤다 — 동네 이름을 알면 그쪽이 더 쓸모 있다.
  { value: '홍대·연남', keywords: ['홍대', '연남', '연트럴'] },
  { value: '합정·망원', keywords: ['합정', '망원', '상수'] },
  { value: '신촌·이대', keywords: ['신촌', '이대', '아현'] },
  { value: '연희·서대문', keywords: ['연희', '서대문', '충정로'] },
  { value: '종로·북촌', keywords: ['종로', '북촌', '삼청', '익선', '안국', '서촌', '인사동'] },
  { value: '을지로·명동', keywords: ['을지로', '명동', '충무로', '광장시장'] },
  { value: '이태원·한남', keywords: ['이태원', '한남', '해방촌', '경리단'] },
  { value: '성수·서울숲', keywords: ['성수', '서울숲', '뚝섬'] },
  { value: '건대·왕십리', keywords: ['건대', '왕십리', '군자', '화양'] },
  { value: '강남·역삼', keywords: ['강남', '역삼', '선릉', '논현'] },
  { value: '신사·압구정', keywords: ['신사', '압구정', '가로수길', '도산'] },
  { value: '청담·삼성', keywords: ['청담', '코엑스', '봉은사'] },
  { value: '서초·방배', keywords: ['서초', '방배', '교대', '양재'] },
  { value: '잠실·송파', keywords: ['잠실', '송파', '석촌', '방이'] },
  { value: '여의도·영등포', keywords: ['여의도', '영등포', '문래', '당산'] },
  { value: '목동·양천', keywords: ['목동', '양천'] },
  { value: '관악·사당', keywords: ['샤로수길', '서울대입구', '사당', '신림', '관악'] },
